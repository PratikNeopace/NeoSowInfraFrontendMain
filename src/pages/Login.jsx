    ...
    <div className="d-flex" style={{ minHeight: '100vh', fontFamily: "'Inter', sans-serif", backgroundColor: '#f8fafc' }}>
      ...
      <div className="d-none d-lg-flex col-lg-6 position-relative flex-column justify-content-between p-5 text-white" style={{
        ...
        <div className="my-auto position-relative" style={{ zIndex: 2, maxWidth: '520px', color: '#1e293b' }}>
          ...
          <div className="d-flex flex-column gap-4">
            ...
            <div className="d-flex align-items-start gap-3">
              <div className="d-flex align-items-center justify-content-center rounded-3 shadow-sm" style={{ width: '42px', height: '42px', minWidth: '42px', backgroundColor: 'rgba(255, 255, 255, 0.4)' }}>
                <i className="fas fa-pencil-ruler" style={{ fontSize: '18px', color: '#174D3A' }}></i>
              </div>
              <div>
                <h6 className="fw-bold mb-1" style={{ fontSize: '15px', color: '#0f172a' }}>Architectural Design</h6>
                <p className="small mb-0" style={{ color: '#475569' }}>Residential, commercial, and interior design solutions.</p>
              </div>
            </div>
            ...
            <div className="d-flex align-items-start gap-3">
              <div className="d-flex align-items-center justify-content-center rounded-3 shadow-sm" style={{ width: '42px', height: '42px', minWidth: '42px', backgroundColor: 'rgba(255, 255, 255, 0.4)' }}>
                <i className="fas fa-file-invoice-dollar" style={{ fontSize: '18px', color: '#174D3A' }}></i>
              </div>
              <div>
                <h6 className="fw-bold mb-1" style={{ fontSize: '15px', color: '#0f172a' }}>Quotation &amp; Cost Estimation</h6>
                <p className="small mb-0" style={{ color: '#475569' }}>Generate accurate BOQs, material estimates, and project quotations.</p>
              </div>
            </div>
            ...
            <div className="d-flex align-items-start gap-3">
              <div className="d-flex align-items-center justify-content-center rounded-3 shadow-sm" style={{ width: '42px', height: '42px', minWidth: '42px', backgroundColor: 'rgba(255, 255, 255, 0.4)' }}>
                <i className="fas fa-tasks" style={{ fontSize: '18px', color: '#174D3A' }}></i>
              </div>
              <div>
                <h6 className="fw-bold mb-1" style={{ fontSize: '15px', color: '#0f172a' }}>Construction Management</h6>
                <p className="small mb-0" style={{ color: '#475569' }}>Track projects from concept to completion with centralized documentation.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="position-relative" style={{ zIndex: 2 }}>
          <div style={{ width: '28px', height: '3px', borderRadius: '2px', backgroundColor: '#174D3A' }} />
        </div>
      </div>
